(() => {
  ...
  const copy = {
    de: {
      ...
      "action.reserve":"Tisch reservieren","action.menu":"Speisekarte entdecken","action.scroll":"Entdecken","action.story":"Unsere Geschichte","action.fullmenu":"Ganze Karte entdecken","action.buildtable":"Tisch zusammenstellen","action.continue":"Weiter","action.back":"Zurück","action.request":"Anfrage senden",
    ...
    nl: {
      ...
      "action.reserve":"Reserveer een tafel","action.menu":"Ontdek het menu","action.scroll":"Ontdekken","action.story":"Ons verhaal","action.fullmenu":"Bekijk de hele kaart","action.buildtable":"Stel je tafel samen","action.continue":"Verder","action.back":"Terug","action.request":"Aanvraag versturen",
    ...
    en: {
      ...
      "action.reserve":"Reserve a table","action.menu":"Explore the menu","action.scroll":"Discover","action.story":"Our story","action.fullmenu":"Explore the full menu","action.buildtable":"Build your table","action.continue":"Continue","action.back":"Back","action.request":"Send request",
